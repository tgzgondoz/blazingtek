    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="py-12 md:py-16 bg-white">
        <div className="max-w-6xl mx-auto px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 mb-3 px-4 py-2 rounded-full bg-blue-50 border border-blue-100">
            ...
            {leaders.map((leader, index) => (
              ...
              >
                <div className="bg-white rounded-xl p-4 shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-100 hover:border-blue-100 text-center">
                  ...
                  <p className="text-gray-600 text-xs mb-3 px-2 py-1 bg-gray-50 rounded-full font-medium">
                    {leader.role}
                  </p>
      ...
      <section className="py-12 md:py-16 bg-gradient-to-br from-gray-50 to-white">
        <div className="max-w-4xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 max-w-3xl mx-auto">
            ...
            >
              <div className="w-12 h-12 rounded-full bg-blue-50 mx-auto mb-4 flex items-center justify-center group-hover:bg-blue-100 transition-colors">
                <Phone className="h-6 w-6 text-blue-500" />
              </div>
              <h3 className="text-base font-semibold text-gray-900 mb-2">Call Us</h3>
              <p className="text-gray-600 text-sm">+1 (555) 123-4567</p>
              <div className="text-blue-500 text-xs font-medium mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                Click to call →
              </div>
            </motion.a>
            ...
            >
              <div className="w-12 h-12 rounded-full bg-emerald-50 mx-auto mb-4 flex items-center justify-center group-hover:bg-emerald-100 transition-colors">
              ...
              <div className="text-emerald-500 text-xs font-medium mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                Click to email →
              </div>
            </motion.a>
            ...
            <motion.a
              ...
              whileHover={{ y: -5 }}
              className="bg-white p-6 rounded-xl border border-gray-200 hover:border-purple-300 hover:shadow-lg transition-all duration-300 group text-center"
            >
              <div className="w-12 h-12 rounded-full bg-purple-50 mx-auto mb-4 flex items-center justify-center group-hover:bg-purple-100 transition-colors">
              ...
              <div className="text-purple-500 text-xs font-medium mt-3 opacity-0 group-hover:opacity-100 transition-opacity">
                View location →
              </div>
            </motion.a>
          </div>
